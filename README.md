...
1. 一句不超过 30 字/词的早安问候（中文 / English / Français 按日轮换，60 天不重复）
2. 过去 24 小时国内要闻 5 条 + 国际要闻 5 条，均标注来源
   （国内聚焦科技、国防、政治、经济、民生与灾害；国际聚焦科技与政治，每天至少包含 1 条 AI 相关新闻）
3. 南京、武汉、南宁、定西市安定区、孝感市应城市的当日天气
...
8. 想立刻更新今天的数据：仓库 **Actions** 页 → 左侧“每日更新晨报” →
   右侧 **Run workflow** 按钮；以后每天 07:30～08:30（北京时间）会自动尝试更新，
   当天只更新一次，无需电脑开机。
...
- 修改新闻源：编辑 `generate.py` 中的 `DOMESTIC_SOURCES` 或 `INTERNATIONAL_SOURCES`。
